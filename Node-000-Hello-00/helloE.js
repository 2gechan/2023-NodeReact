...
// 나머지(전화,나이,취미, 성별)는 또다른 객체로 복제하는 구조분해
const { 성명, 주소, ...나머지 } = address;
console.log(성명, 주소, 나머지);

// 배열의 구조분해
// n1과 n2에는 nums 배열의 0번(1) 1번(2)가 각각 할당되고
...
// 나머지는 nums에 배열처럼 받는다
func(1, 2, 3, 4, 5, 6, 5, 5, 2, 34, 234, 1);
...
func1(10, 20, 10, 1, 2, 3, 7, 7, 9, 2234);
/*
JS의 나머지 연산자
