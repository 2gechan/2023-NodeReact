 ...
 * 보통 react-router-dom에서 다른 페이지를 열고자 할 때 NavLink를 사용하여
 * a tag를 생성하고 페이지 전환을 한다.
 *
 * 하지만 button 등 tag를 사용할 때는 onClick event를 캡춰하여 페이지를
 * 전환해야 하는데 이때는 NavLink를 사용하기가 다소 불편해진다.
 * 이럴 때 useNavigate() hooks 함수를 사용하여 객체를 생성하고
 ...
 *
 * 특히 useRedirect의 경우 별도로 Navigate Component를 통하여 실행할 수도 있다.
 */
